namespace Edi
{
    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            InitializePlugins(
                  typeof(InstallSetting)
                , typeof(InstallCore)
                , typeof(InstallIOutput)
                , typeof(InstallDocuments)
                , typeof(InstallFile)
                , typeof(InstallMlib)
                , typeof(InstallMsgBox)
                );
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            try
            {
                ...
                settingsManager = (ISettingsManager)_Container.GetService(typeof(ISettingsManager));
                themesManager = (IThemesManager)_Container.GetService(typeof(IThemesManager));
                _AppCore = (IAppCore)_Container.GetService(typeof(IAppCore));
                ...
                AppViewModel = (IApplicationViewModel)_Container.GetService(typeof(IApplicationViewModel));
            ...
            var start = (IShell<MainWindow>)_Container.GetService(typeof(IShell<MainWindow>));     // Resolve
            ...
            var msgBox = (IMessageBoxService)_Container.GetService(typeof(IMessageBoxService));
            ...
            var output = (IMessageManager)_Container.GetService(typeof(IMessageManager));
        ...
        private void InitializePlugins(params Type[] types)
        {

            EdiEnvironment env = new EdiEnvironment()
            {

                Name = "Default",

                BaseDirectory = new FileInfo(System.Reflection.Assembly.GetAssembly(typeof(EdiEnvironment)).Location).Directory,
            ...
            TypeDiscovery.Instance.AddDirectories(env.GetDirectories());
        ...
        private IServiceProvider RegisterPlugins()
        {

            var container = new ImplementationCastle();
            var _configcontainer = new ComponentObject(container)
                .AddInstallers(TypeDiscovery.Instance.GetTypes(typeof(BaseIocRegister)))
                .ApplyBuild()
                .Configure()
        ...
        protected override void OnSessionEnding(SessionEndingCancelEventArgs e)
        {
            ...
            try
            {
                if (_Container is IDisposable d)
                    d.Dispose();
                //_Container = null;
            }
            catch (Exception exp)
        ...
        private void App_DispatcherUnhandledException(object sender, DispatcherUnhandledExceptionEventArgs e)
        {
            ...
            try
            {
                ...
                var msgBox = (IMessageBoxService)_Container.GetService(typeof(IMessageBoxService));
                var appCore = (IAppCore)_Container.GetService(typeof(IAppCore));
